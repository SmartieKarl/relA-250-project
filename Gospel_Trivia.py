...
Disclaimer:
Currently, The question file is loaded with questions generated by AI.
It used the study guides as reference material. This is only for demo
reasons, it would have taken forever to compile 50 questions by myself,
and this project already has taken me 15 hours or so to code.
...
class Button(pygame.sprite.Sprite):
    def __init__(
        ...
        self.normal_image_base = pygame.image.load(image).convert_alpha()
        self.hover_image_base = pygame.image.load(hover_image).convert_alpha()
...
class TitleState:
    def __init__(self, engine):
        ...
        self.background = pygame.image.load("img/bg/title.jpg")
        self.background = pygame.transform.scale(self.background, (S_WIDTH, S_HEIGHT))
        self.foreground = pygame.image.load("img/fg/title.png")
...
class OptionsState:
    def __init__(self, engine):
        ...
        self.background = pygame.image.load("img/bg/options.jpg")
        self.background = pygame.transform.scale(self.background, (S_WIDTH, S_HEIGHT))
        self.foreground = pygame.image.load("img/fg/options.png")
        self.foreground = pygame.transform.scale(self.foreground, (S_WIDTH, S_HEIGHT))
...
class TriviaState:
    def __init__(self, engine):
        ...
        pygame.transform.scale(
            pygame.image.load(f"img/bg/trivia{i}.jpg"),
            (S_WIDTH, S_HEIGHT)
            )
            for i in range(1, 11)]
...
class GameOverState:
    def __init__(self, engine):
        ...
        self.background = pygame.image.load("img/bg/game-over.jpg")
        self.background = pygame.transform.scale(self.background, (S_WIDTH, S_HEIGHT))
        self.foreground = pygame.image.load("img/fg/game-over.png")
        self.foreground = pygame.transform.scale(self.foreground, (S_WIDTH, S_HEIGHT))
